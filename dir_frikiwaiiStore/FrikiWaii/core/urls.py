...
from .views import home, alien, audifonos, bunny, car_avengers, car_naruto,
carro, crybaby, desc_accesorios, desc_bags, desc_gamerstyle, desc_outfits,
desc_papeleria, desc_phonecase, inosuke, joker, llavero, memo, momo, muerto,
penny, pokemochila, sacapuntas, sudadera
...
urlpatterns = [
    ...
    path('Carcasa-avengers/', car_avengers, name="car-avengers"),
